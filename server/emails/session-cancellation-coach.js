const sessionCancellationCoachTemplate = (date, time, client, name) => {
  return `
    <!DOCTYPE html>
<html>
  <head>
  ...
  <body>
    <div class="container">
      ...
      <p class="msg">
        We are sorry to inform you that your session has been cancelled. Please
        find the session details below.
      </p>
      <div class="data">
        <p>Session Date: ${date}</p>
        <p>Session Time: ${time}</p>
        <p>Session Client: ${client}</p>
      </div>
      <div class="footer">
        <p class="mail-to">
...
module.exports = { sessionCancellationCoachTemplate };
