const sessionUpdateCoachTemplate = async (name, date, time, client) => {
  return `
    <!DOCTYPE html>
<html>
  <head>
  ...
  <body>
    <div class="container">
      ...
      <p class="msg">
        Client has updated the session details. Please find the new session
        details below:
      </p>
      <div class="data">
...
module.exports = { sessionUpdateCoachTemplate };
