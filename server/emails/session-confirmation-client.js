const sessionConfirmationClientTemplate = (name, date, time, coach, price) => {
  return `
    <!DOCTYPE html>
<html>
  <head>
  ...
  <body>
    <div class="container">
      ...
      <p class="msg"><b>Your Session is confirm :</b></p>
      <div class="data">
...
module.exports = { sessionConfirmationClientTemplate };