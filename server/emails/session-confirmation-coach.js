const sessionConfirmationCoachTemplate = (
  name,
  date,
  time,
  client,
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p class="msg"><b>Your have new Session request</b></p>
      <div class="data">
        <p>Session Date: ${date}</p>
        <p>Session Time: ${time}</p>
        <p>Session Client: ${client}</p>
        <p>Session Price: ${price} LKR</p>
      </div>
      <div class="footer">
        <p class="mail-to">
...
module.exports = { sessionConfirmationCoachTemplate };
